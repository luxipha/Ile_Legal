var Stage = /** @class */ (function () {
    function Stage() {
        ...
        this.wwidth = (window.innerWidth < 768) ? window.innerWidth : window.innerWidth / 2
        // renderer
        this.renderer = new THREE.WebGLRenderer({
            antialias: true,
            alpha: false
        });
        this.renderer.setSize(this.wwidth, window.innerHeight);
        this.renderer.setClearColor('#ECF3F7', 1);
        this.container.appendChild(this.renderer.domElement);
        // scene
        this.scene = new THREE.Scene();
        // camera
        var aspect = this.wwidth / window.innerHeight;
        var d = 20;
    ...
    Stage.prototype.onResize = function () {
        var viewSize = 30;
        this.renderer.setSize(this.wwidth, window.innerHeight);
        this.camera.left = this.wwidth / -viewSize;
        this.camera.right = this.wwidth / viewSize;
...
var Game = /** @class */ (function () {
    function Game() {
        ...
        this.mainContainer.addEventListener('keydown', function (e) {
            if (e.key == 32)
                _this.onAction();
        });
        ...
        this.mainContainer.addEventListener('touchstart', function (e) {
            e.preventDefault();
            _this.onAction();
        });
    }
