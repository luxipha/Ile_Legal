...
interface Gig {
  ...
  provider: string;
  amount: string;
  status: "active" | "pending" | "completed" | "flagged" | "in progress" | "pending assignment" | "suspended" | "pending_payment";
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="text-right ml-6">
                  ...
                  <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium mb-2 ${
                    ...
                    gig.status === "completed" || gig.status === "pending_payment" ? "bg-gray-100 text-gray-800" :
